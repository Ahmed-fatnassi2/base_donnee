...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 08 fév. 2023 à 17:37
...
--
-- Structure de la table `prd-ing`
--

CREATE TABLE `prd-ing` (
  `id_ingredient` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Contraintes pour la table `prd-ing`
--
ALTER TABLE `prd-ing`
  ADD CONSTRAINT `prd-ing_ibfk_2` FOREIGN KEY (`id_produit`) REFERENCES `product` (`id_product`),
  ADD CONSTRAINT `prd-ing_ibfk_3` FOREIGN KEY (`id_ingredient`) REFERENCES `ingredients` (`id_ingredient`);
